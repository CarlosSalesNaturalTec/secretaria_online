...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const requestTypes = [
      {
        name: 'Matrícula - Pedido de Atestado',
      ...
      {
        name: 'Matrícula - Renovação',
        description: 'Solicitação de renovação de matrícula para o próximo período letivo',
      ...
      {
        name: 'Matrícula - Cancelamento',
        description: 'Solicitação de cancelamento definitivo de matrícula no curso',
        response_deadline_days: 5,
        is_active: true,
        created_at: new Date(),
        updated_at: new Date(),
      ...
      {
        name: 'Outros',
        description: 'Outras solicitações não especificadas anteriormente',
        response_deadline_days: 15,
        is_active: true,
        created_at: new Date(),
        updated_at: new Date(),
